...
| Dashboard authoring | 25 dashboard ops | Curated tools + generic API | Create/get/update/archive/delete/copy dashboards, public links, parameters, durable snapshots, saved snapshot restore, and dashboard card layouts are curated. Tabs and subscriptions are generic today. |
